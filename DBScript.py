...
def extract_info(text):
    ...
    books_info = []
    for title, author, genre, publisher, publish_date, isbn, price in zip(titles, authors, genres, publishers, publish_dates, isbns, prices):
        book_info = {
            "Title": title,
            "Author": author,
            "Genre": genre,
...
for book in books_info:
    c.execute("INSERT INTO books VALUES (?, ?, ?, ?, ?, ?, ?)", (book['Title'], book['Author'], book['Genre'], book['Publisher'], book['Publish Date'], book['ISBN'], book['Price']))
